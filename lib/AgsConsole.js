...
AgsConsole.prototype.configureCaporal = function () {
    this.caporal
        ...
        .help(wrap('To clean the code of a AGS project, you must launch this command into the root folder of the AGS project. Or you can launch this command anywhere, and specify with <directory> options where is the folder AGS project to clean.', this.defaultWrapOptions))
        ...
        .help(wrap('To generate a Windows setup of a AGS project, in order to simplify deployment. Or you can launch this command anywhere, and specify with <directory> options where is the folder AGS project to clean.', this.defaultWrapOptions))
        .option('-o, --output <output>', 'Specify the <output> folder where the setup is generated.')
