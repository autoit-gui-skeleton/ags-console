...
Func _GUI_build_view_to_CheckForUpdates($main_GUI, $resultCheckForUpdate, $context = "")
	...
	If ($context = "ON_STARTUP" And $resultCheckForUpdate[0] = "UPDATE_AVAILABLE") Or ($context <> "ON_STARTUP") Then
		...
		_GUICtrl_OnHoverRegister($label_update_download, "_GUICtrl_MouseOver_Label", "_GUICtrl_MouseLeave_Func")
		...
		_GUICtrl_OnHoverRegister($label_update_release_notes, "_GUICtrl_MouseOver_Label", "_GUICtrl_MouseLeave_Func")
